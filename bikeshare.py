...
def get_filters():
    ...
    while True:
        city =input("Please enter the city you would like to display data for:\n Choices: Chicago, New York City, Washington\n").lower()
        if city in cities:
            break
        else:
    ...
    while True:
        ...
        if choice == 'month':
            month = input("Please enter the month you would like to display data for. If you do not want to filter by month enter 'all'. \nChoices: All, January, February, March, April, May, June\n").lower()
            day = 'all'
            if month in months:
                break
            else:
            ...
            day = input("Please enter the day of the week you would like to display data for. If you do not want to filter by day enter 'all'. \nChoices: All, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday\n").lower()#PB
            month = 'all'
            if day in days:
                break
            else:
